    ...
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white rounded-lg border border-gray-200">
          <img
            className="w-16 mx-auto mb-4 opacity-40"
        ...
        <div className="space-y-4">
          {orders.map((order, index) => {
            ...
            return (
              <div
                key={order._id || index}
                className="grid grid-cols-1 md:grid-cols-[0.5fr_2fr_1fr_1fr_1fr] gap-4 items-start border border-gray-200 rounded-lg p-5 sm:p-6 bg-white shadow-sm hover:shadow-md transition"
              >
                ...
                <div>
                  <select
                    ...
                    className="w-full p-2 text-xs sm:text-sm font-semibold border rounded-md bg-gray-50 border-gray-300 focus:outline-none focus:ring-2 focus:ring-black"
                  >
